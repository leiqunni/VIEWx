    ...
    Private Sub FormMain_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            If e.Button = Windows.Forms.MouseButtons.Right Then
                ...
                Select Case strokes
                    ...
                    Case "RU"
                        ...
                        End If
                    Case "RULD"
                        mnuViewBestfit_Click(Nothing, Nothing)
                    Case "LURD"
                        mnuViewActual_Click(Nothing, Nothing)
                End Select
            End If
        End Sub
        ...
        Private Sub FormMain_MouseMove(ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles Me.MouseMove, PictureBox1.MouseMove
            ...
            If gestureStarted Then
                ...
                If tsStatusBar.Visible Then ToolStripStatusLabel1.Text = "マウス ジェスチャ " & strokes

                dirX = e.X - exX : absX = Math.Abs(dirX)
                dirY = e.Y - exY : absY = Math.Abs(dirY)

                If absX < 15 And absY < 15 Then Return
